...
def switch_to_original_desktop() -> bool:
    ...
    try:
        from smartdesk.core.services.desktop_service import get_all_desktops, switch_to_desktop, sync_desktop_state_and_apply_icons
...
def stop_services() -> bool:
    ...
    try:
        ...
        smartdesk_keywords = ["tray", "listener", "actions", "control_panel", "gui_main", "main.py", "tray_icon.py", "screen_fade.py"]
...
def main():
    ...
    parser.add_argument("--keep-data", action="store_true", help="Behält den AppData-Ordner")
    parser.add_argument("--force", "-f", action="store_true", help="Keine Bestätigungen erfragen")
