...
def backup_registry_paths():
    ...
    try:
        ...
        # Der vollständige Dateipfad für die Sicherungs-JSON (NEUER NAME)
        backup_file = os.path.join(backup_dir, 'registry_paths_backup.json')

        # --- Skriptlogik ---
        
        print("Starte Sicherung...")
        ...
        # 3. Desktop-Hintergrundbild auslesen
        ...
        # 4. Daten in JSON konvertieren und in die Datei schreiben
