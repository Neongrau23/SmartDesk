...
# --- Projekt-Imports ---
try:
    # Relative Imports, da diese Datei in smartdesk/ui/ liegt
    ...
    try:
        # Pfad-Hack, um 'src' (übergeordneter Ordner von 'smartdesk') hinzuzufügen
        current_dir = os.path.dirname(os.path.abspath(__file__)) # .../smartdesk/ui
        smartdesk_dir = os.path.dirname(current_dir) # .../smartdesk
        src_dir = os.path.dirname(smartdesk_dir) # .../src
