...
class LogoWindow:
    ...
    def animate_spinner(self):
        ...
        for i, dot in enumerate(self.animation_objects):
            ...
            self.animation_canvas.coords(dot, x - dot_size, y - dot_size, x + dot_size, y + dot_size)
    ...
    def animate_pulse(self):
        ...
        for i, circle in enumerate(self.animation_objects):
            ...
            self.animation_canvas.coords(circle, cx - size, cy - size, cx + size, cy + size)
    ...
    def animate_wave(self):
        ...
        for i, bar in enumerate(self.animation_objects):
            ...
            self.animation_canvas.itemconfig(bar, fill=cfg.ANIMATION_CONFIG["primary_color"])
    ...
    def animate_dots(self):
        ...
        for i, dot in enumerate(self.animation_objects):
            ...
            # Stelle sicher, dass die Farbe korrekt ist
            self.animation_canvas.itemconfig(dot, fill=cfg.ANIMATION_CONFIG["primary_color"])
