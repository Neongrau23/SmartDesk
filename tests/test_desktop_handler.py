...
class TestDesktopModelIntegration:
    ...
    def test_desktop_data_roundtrip(self, tmp_path):
        ...
        with patch("smartdesk.core.storage.file_operations.get_data_file_path", return_value=str(json_file)):
            desktop = Desktop(name="Test", path=str(tmp_path / "TestDesktop"), is_active=True)
...
class TestUpdateDesktopLogic:
    ...
    def test_name_conflict_detection(self, tmp_path):
        ...
        with patch("smartdesk.core.storage.file_operations.get_data_file_path", return_value=str(json_file)):
            ...
            new_name = "Desktop2"
            name_conflict = any(d.name == new_name for d in loaded if d.name != "Desktop1")
...
class TestIconPositionLogic:
    ...
    def test_save_icon_positions(self, tmp_path):
        ...
        with patch("smartdesk.core.storage.file_operations.get_data_file_path", return_value=str(json_file)):
            ...
            desktop = Desktop(name="WithIcons", path="C:\\Desktop", icon_positionen=icons)
            save_desktops([desktop])
    ...
    def test_empty_icon_positions(self, tmp_path):
        ...
        with patch("smartdesk.core.storage.file_operations.get_data_file_path", return_value=str(json_file)):
            desktop = Desktop(name="NoIcons", path="C:\\Desktop", icon_positionen=[])
            save_desktops([desktop])
    ...
    def test_update_icon_positions(self, tmp_path):
        ...
        with patch("smartdesk.core.storage.file_operations.get_data_file_path", return_value=str(json_file)):
            ...
            # Icons hinzufügen
            loaded = load_desktops()
            loaded[0].icon_positionen = [IconPosition(index=0, name="NewIcon", x=50, y=50)]
            save_desktops(loaded)
...
class TestWallpaperLogic:
    ...
    def test_wallpaper_path_persistence(self, tmp_path):
        ...
        with patch("smartdesk.core.storage.file_operations.get_data_file_path", return_value=str(json_file)):
            desktop = Desktop(name="WithWallpaper", path="C:\\Desktop", wallpaper_path="C:\\Wallpapers\\image.jpg")
            save_desktops([desktop])
    ...
    def test_empty_wallpaper_path(self, tmp_path):
        ...
        with patch("smartdesk.core.storage.file_operations.get_data_file_path", return_value=str(json_file)):
            desktop = Desktop(name="NoWallpaper", path="C:\\Desktop", wallpaper_path="")
            save_desktops([desktop])
