...
from smartdesk.hotkeys.interfaces import (
    ProcessResult,
    ProcessState,
    StartResult
)
from smartdesk.hotkeys.listener_manager import (
    ListenerManager,
    ListenerStatus
)
...
class TestListenerStatus:
    ...
    def test_status_running_when_process_exists(
        self, mock_controller, mock_storage, mock_starter, test_command, test_working_dir
    ):
    ...
    def test_status_stopped_when_process_not_running(
        self, mock_controller, mock_storage, mock_starter, test_command, test_working_dir
    ):
...
class TestListenerStart:
    ...
    def test_start_fails_when_python_not_found(
        self, mock_controller, mock_storage, mock_starter, test_command, test_working_dir
    ):
...
class TestListenerStop:
    ...
    def test_stop_success_graceful(
        self, mock_controller, mock_storage, mock_starter, test_command, test_working_dir
    ):
    ...
    def test_stop_when_process_not_found(
        self, mock_controller, mock_storage, mock_starter, test_command, test_working_dir
    ):
